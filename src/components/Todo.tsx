...
export default function Todo(todo: Todo) {
    ...
    const isMutating = isFetching || isFetching
        ...
        <article className="my-4 flex justify-between items-center" style={{ opacity: !isMutating ? 1 : 0.7 }}>
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    ...
                    disabled={isPending}
                    className="p-3 text-xl rounded-2xl text-black border-solid border-black bordre-2 max-w-xs bg-red-400 hover:cursor-pointer hover:bg-red-300"
                >
                    <FaTrash />
                </button>
            </div>
